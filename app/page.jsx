  ...
  return (
    <main className="min-h-screen bg-gray-50 pb-12">
      ...
      <div className="max-w-md mx-auto p-4 space-y-4">
        ...
        {activeTab === 'today' && (
          <div className="space-y-4">
            <div className="bg-white rounded-2xl p-5 shadow-sm border border-orange-100">
              <h2 className="text-base font-bold text-orange-700 mb-3 flex items-center justify-between">
                <span>📅 今日排班列表</span>
                <span className="text-xs font-normal text-gray-500">{todayStr}</span>
              </h2>

              {todayShifts.length === 0 ? (
                <div className="text-center py-8 text-gray-400 text-sm">
                  今日尚無排班資料，請至「後台管理」上傳並透過 AI 解析班表圖片。
                </div>
              ) : (
        ...
        {activeTab === 'weekly' && (
          <div className="bg-white rounded-2xl p-5 shadow-sm border border-orange-100">
            <h2 className="text-base font-bold text-orange-700 mb-3">📊 本週所有班表彙整</h2>
            {shifts.length === 0 ? (
              <div className="text-center py-8 text-gray-400 text-sm">
                目前沒有任何班表資料。
              </div>
